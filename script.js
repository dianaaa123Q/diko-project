...
async function getTodosFromDatabase() {
    const apiUrl = `https://657abd3f1acd268f9afbc3de.mockapi.io/user/tasks/${sharedVariable}/ToDo`;
...
async function updateTodoStatusInDatabase(todoId, completedStatus) {
  const apiUrl = `https://657abd3f1acd268f9afbc3de.mockapi.io/user/tasks/${sharedVariable}/ToDo/${todoId}`;
